					...
					<div class="row justify-content-between">
						...
						<div class="col-lg-7">
							<div class="hero-img-wrap">
								<img src="/The-Divine-Decor/the-divine-door-main/02User-side/images/couch.png" class="img-fluid">
							</div>
		      	...
		      	<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="/The-Divine-Decor/the-divine-door-main/02User-side/images/product-2.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">Kruzo Aero Chair</h3>

							<span class="icon-cross">
								<img src="/The-Divine-Decor/the-divine-door-main/02User-side/images/cross.svg" class="img-fluid">
							</span>
						</a>
					</div>
					 End Column 3
